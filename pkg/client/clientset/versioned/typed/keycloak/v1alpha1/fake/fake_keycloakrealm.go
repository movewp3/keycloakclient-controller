...
var keycloakrealmsResource = schema.GroupVersionResource{Group: "keycloak", Version: "v1alpha1", Resource: "keycloakrealms"}

var keycloakrealmsKind = schema.GroupVersionKind{Group: "keycloak", Version: "v1alpha1", Kind: "KeycloakRealm"}
...
func (c *FakeKeycloakRealms) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(keycloakrealmsResource, c.ns, name, opts), &v1alpha1.KeycloakRealm{})
