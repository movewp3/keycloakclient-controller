...
var keycloaksResource = schema.GroupVersionResource{Group: "keycloak", Version: "v1alpha1", Resource: "keycloaks"}

var keycloaksKind = schema.GroupVersionKind{Group: "keycloak", Version: "v1alpha1", Kind: "Keycloak"}
...
func (c *FakeKeycloaks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(keycloaksResource, c.ns, name, opts), &v1alpha1.Keycloak{})
