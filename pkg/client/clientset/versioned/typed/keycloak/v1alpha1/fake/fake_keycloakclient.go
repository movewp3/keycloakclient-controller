...
var keycloakclientsResource = schema.GroupVersionResource{Group: "keycloak", Version: "v1alpha1", Resource: "keycloakclients"}

var keycloakclientsKind = schema.GroupVersionKind{Group: "keycloak", Version: "v1alpha1", Kind: "KeycloakClient"}
