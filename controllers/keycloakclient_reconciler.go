...
func (i *DedicatedKeycloakClientReconciler) ReconcileServiceAccountRoles(state *common.ClientState, cr *kc.KeycloakClient, desired *common.DesiredClusterState) {
	if state.ServiceAccountUserState != nil {
		logKcc.Info("Reconciling service account roles")
		desired.AddActions(GetUserRealmRolesDesiredState(state.ServiceAccountUserState, cr.Spec.ServiceAccountRealmRoles, state.Realm.Spec.Realm.Realm))
		desired.AddActions(GetUserClientRolesDesiredState(state.ServiceAccountUserState, cr.Spec.ServiceAccountClientRoles, state.Realm.Spec.Realm.Realm))
	} else {
		logKcc.Info("Service account not found, skipping roles reconciliation")
	}
}
...
func (i *DedicatedKeycloakClientReconciler) pingKeycloak() common.ClusterAction {
	return common.PingAction{
		Msg: "check if keycloak is available",
	}
}

func (i *DedicatedKeycloakClientReconciler) getDeletedClientState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedDeprecatedClientSecretState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getUpdatedClientSecretState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getUpdatedClientState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientSecretState(state *common.ClientState, cr *kc.KeycloakClient) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientRoleState(state *common.ClientState, cr *kc.KeycloakClient, role *kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getUpdatedClientRoleState(state *common.ClientState, cr *kc.KeycloakClient, role, oldRole *kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedClientRoleState(state *common.ClientState, cr *kc.KeycloakClient, role *kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getAddedDefaultClientRolesState(state *common.ClientState, cr *kc.KeycloakClient, roles *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedDefaultClientRolesState(state *common.ClientState, cr *kc.KeycloakClient, roles *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientRealmScopeMappingsState(state *common.ClientState, cr *kc.KeycloakClient, mappings *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedClientRealmScopeMappingsState(state *common.ClientState, cr *kc.KeycloakClient, mappings *[]kc.RoleRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientClientScopeMappingsState(state *common.ClientState, cr *kc.KeycloakClient, mappings *kc.ClientMappingsRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedClientClientScopeMappingsState(state *common.ClientState, cr *kc.KeycloakClient, mappings *kc.ClientMappingsRepresentation) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getCreatedClientOptionalClientScopeState(state *common.ClientState, cr *kc.KeycloakClient, clientScope *kc.KeycloakClientScope) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedClientDefaultClientScopeState(state *common.ClientState, cr *kc.KeycloakClient, clientScope *kc.KeycloakClientScope) common.ClusterAction {
...
func (i *DedicatedKeycloakClientReconciler) getDeletedClientOptionalClientScopeState(state *common.ClientState, cr *kc.KeycloakClient, clientScope *kc.KeycloakClientScope) common.ClusterAction {
